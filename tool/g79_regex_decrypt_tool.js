...
const patchVersion = '3.3.39.270672';
...
try {
  ...
  const encryptedFileName = `./g79_regex_${patchVersion}_encrypted_${encryptedMD5}.txt`;
  ...
  const decryptedFileName = `./g79_regex_${patchVersion}_decrypted_${decryptedMD5}.txt`;
